...
public class CustomCircuirtBreakerConfig {
    ...
    public ReactiveResilience4JCircuitBreakerFactory reactiveResilience4JCircuitBreakerFactory() {
        ...
        CircuitBreakerConfig circuitBreakerConfig = CircuitBreakerConfig.custom()
                ...
                .slidingWindowSize(2) // 窗口大小2秒
                .minimumNumberOfCalls(5) // 最少的请求数 5次
                .failureRateThreshold(80) // 失败阈值 80%
                .enableAutomaticTransitionFromOpenToHalfOpen() // 运行开关自动从打开状态切换到半开状态
                .waitDurationInOpenState(Duration.ofSeconds(10)) // 断路器从打开状态到半开状态的时长是10s
        ...
        factory.configureDefault(id -> new Resilience4JConfigBuilder(id)
                // 响应时间不超过600毫秒，是一个正常请求。超过600毫秒就是一个失败请求
