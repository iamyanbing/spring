 ...
 * 我们通常需要自己增加一些说明来丰富文档内容。在UserController类中，
 * 通过@Api、@ApiOperation注解来给API增加说明、
 * 通过@ApiImplicitParams、@ApiImplicitParam、@ApiModel、@ApiModelProperty注解来给参数增加说明。
 * <p>
 * <p>
...
public class Swagger2 {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.iamyanbing.web"))
